...
async def homepage(request: Request):
    ...
    if user:
        return HTMLResponse(f'<h1>Hello, {user["email"]}!</h1><p><a href="/id_token">Get Token</a></p><p><a href="/logout">Logout</a></p>')
    return HTMLResponse('<h1>Welcome!</h1><p><a href="/login">Login with Google</a></p>')
